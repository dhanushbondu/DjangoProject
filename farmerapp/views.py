...
#         Profile.objects.create(user=user, city=c, address=ad,image=i, user_type=t)
...
def Signup(request):
    if request.method == 'POST':
        try:
            ...
            ad = request.POST['add']
            e = request.POST['email']
            i = request.FILES['img']  # This line may cause MultiValueDictKeyError
            t = request.POST['type']
            ...
            # Handle the case where 'img' key is not found in request.FILES
